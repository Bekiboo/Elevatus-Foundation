  ...
  <div class="overflow-y-auto py-4 px-3 bg-slate-800 h-screen">
    <ul class="space-y-2 text-slate-500">
      ...
      <li>
        <a
          href="#"
          class="flex items-center p-2 text-base hover:text-white"
        >
          <svg
            aria-hidden="true"
      ...
      <li>
        ...
        >
          ...
          <span
            class="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium rounded-full bg-blue-900 text-blue-200"
            >3</span
          >
        </a>
      </li>
